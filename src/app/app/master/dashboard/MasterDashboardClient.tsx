          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-[1.35fr_0.9fr_0.9fr_0.9fr_0.9fr_1.35fr]">
            ...
            <Card title="Pagos por revisar">
              <div className="space-y-0.5 text-[11px]">
                <button
                  className="flex w-full items-center justify-between rounded-md border border-[#242433] bg-[#0B0B0D] px-2.5 py-0.5 text-left hover:border-[#FEEF00]/40"
                  onClick={() => {
            ...
            <Card title="Deliveries">
              <div className="space-y-0.5 text-[11px]">
                <div className="flex items-center justify-between rounded-md border border-[#242433] bg-[#0B0B0D] px-2.5 py-0.5">
