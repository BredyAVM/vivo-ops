-- Counter Block 6: exact execution of a delivery digital-change obligation.
--
-- Counter records the obligation at dispatch. The assigned advisor executes it;
-- Master/Admin executes it when the order has no advisor. Admin keeps override.
